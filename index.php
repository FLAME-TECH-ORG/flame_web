          ...
          <div class="col-lg-7 d-flex flex-column justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="content">
              ...
              <p>
                ...
                categories to choose from and admission is open to persons in all parts of the world. ISM 2024 class starts on the 12th of April, 2024.           
              </p>
              <div class="text-center text-lg-start">
        ...
        <div class="row gy-4 portfolio-container" data-aos="fade-up" data-aos-delay="200">   
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                <div class="portfolio-links">
                  <a href="assets/img/55.png" data-gallery="portfolioGallery" class="portfokio-lightbox"><i class="bi bi-plus"></i></a>
                </div>
              </div>
            </div>
          </div>
